...
def parse_args():
    ...
    parser.add_argument(
        "--tol", type=float, default=0.0, help="Tolerance for convergence"
    )
    parser.add_argument(
        "--max_iter", type=int, default=1e6, help="Maximum number of iterations"
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
    ...
    parser.add_argument(
        "--cb_rate", type=int, default=100, help="Callback rate for the optimizer"
    )
    parser.add_argument(
        "--optimizer",
        default="SGD",
