...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.95\textwidth]{figs/weight_distribution.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.45]{figs/K2_correlations.pdf}
    \hspace{0.5cm}
    \includegraphics[scale=0.45]{figs/K3_correlations.pdf}
