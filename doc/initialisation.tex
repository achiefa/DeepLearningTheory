...
initialization, is also shown. The figure illustrates that the distribution of
...
\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.4]{section_2/K1_correlations.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{section_2/prior.pdf}
    \caption{Plot of the ensemble of neural networks at initialisation.}        
