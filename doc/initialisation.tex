...
$\gamma^{(\ell)}$.\footnote{ We have denoted {\em all}\ couplings by
  $\gamma^{{(\ell)}}$. Different couplings are indentified by the number of
...
$1/n_\ell$, see, \eg\, Ref.~\cite{Roberts:2021fes} for a detailed presentation
of these ideas. While the actual calculations become rapidly cumbersome, the
conceptual framework is straightforward.

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.55]{section_2/K1_correlations.pdf}
    \includegraphics[scale=0.55]{section_2/K2_correlations.pdf}
    \includegraphics[scale=0.55]{section_2/K3_correlations.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth]{section_2/delta_K.pdf}
...
an ensemble replicas in Fig.~\ref{Fig:KRecursion} for the first two deep-layers
