...
In this analysis we employ a simplified framework where one single flavor in
...
\paragraph{Level 0}
The pseudo-data are generated without any experimental noise, \ie, by simply using
