...
condition. 
\ldd{obtained by training another ensemble of networks drawn from the same prior
distribution using GD.}
This comparison is shown in Fig.~\ref{fig:EvolutionGridF0L2} for L2
