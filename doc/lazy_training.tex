...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.90\textwidth]{section_4/bias/bias_L0_func.pdf}
  \includegraphics[width=0.90\textwidth]{section_4/bias/bias_L1_func.pdf}
  \includegraphics[width=0.90\textwidth]{section_4/bias/bias_L2_func.pdf}
  \caption{Same as Fig.~\ref{fig:BiasDecomposition}, but measuring the bias in the
  functional space of the PDF. Formally, this corresponds to replacing the matrix $M$ in
  Eq.~\eqref{eq:BiasDef} with the identity matrix. Each column corresponds to a different
  frozen NTK.
  \label{fig:BiasDecompositionFunc}}
\end{figure}
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.90\textwidth]{section_4/variance/variance_L0_func.pdf}
  \includegraphics[width=0.90\textwidth]{section_4/variance/variance_L1_func.pdf}
  \includegraphics[width=0.90\textwidth]{section_4/variance/variance_L2_func.pdf}
  \caption{Same as Fig.~\ref{fig:VarianceDecomposition}, but measuring the variance in the
  functional space of the PDF. Formally, this corresponds to replacing the matrix $M$ in
  Eq.~\eqref{eq:VarianceDecomposition} with the identity matrix. Each column corresponds to a different
  frozen NTK.
  \label{fig:VarianceDecompositionFunc}}
\end{figure}
