...
are drawn from some probability distribution. In 
the NNPDF formalism each replica is an instance of i.i.d. stochastic variables. The probability distribution
...
In this section, we review the basic results for the large-network limit at inizialization and compare the theoretical 
predictions with the theoretical expectations for the typical networks used by the NNPDF collaboration. 
In the process we introduce the notation that is used for the networks in the rest of the paper. 
