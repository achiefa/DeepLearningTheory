...
identifies a flavor, and the length of the side of the block is equal to the
size of the grid. 
% Figure ----------------------
\begin{figure}[h]
  \centering
...
orthogonal space; then the result is transformed back to the original flavor
