...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.32\textwidth]{ntk_eigvals.pdf}
  \includegraphics[width=0.32\textwidth]{m_eigvals.pdf}
  \includegraphics[width=0.32\textwidth]{Htilde_eigvals.pdf}
  \caption{Eigenvalues of the NTK (left), of $\tilde{H}$ (centre), 
