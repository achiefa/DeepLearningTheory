...
\begin{align}
    \bar{f}_{t,\alpha} = \mathbb{E}\left[f_{t,\alpha}\right]
        &= U(t)_{\alpha\alpha'} \bar{f}_{0,\alpha'} + V(t)_{\alpha I} Y_I \\
        \label{eq:MeanValAtT}
        &= V(t)_{\alpha I} Y_I\, ,
\end{align}
where we used the fact that the central value of the replicas at initialization is zero.
Eq.~\eqref{eq:MeanValAtT} explicitly show the contribution of each data point to the central value of the 
