...
evolution operator $V(t)_{\alpha I}$. In this respect, the trained NNs behave like other well-known lienar methods for 
...
\end{align}
We see explicitly that the fluctuations of the fields at initialization yield a contriburtion to 
...
\end{align}
where we used the fact that the fluctuations of the data $Y$ are statistically independenct from 
