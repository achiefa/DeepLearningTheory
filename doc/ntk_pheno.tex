...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.48\textwidth]{../plots/ntk_eigvals_L0_L1_L2_n_1.pdf}
  \includegraphics[width=0.48\textwidth]{../plots/ntk_eigvals_L0_L1_L2_n_2.pdf}
  \includegraphics[width=0.48\textwidth]{../plots/ntk_eigvals_L0_L1_L2_n_3.pdf}
  \includegraphics[width=0.48\textwidth]{../plots/ntk_eigvals_L0_L1_L2_n_4.pdf}
  \includegraphics[width=0.48\textwidth]{../plots/ntk_eigvals_L0_L1_L2_n_5.pdf}
  \vspace{0.5cm}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.45\textwidth]{../plots/delta_ntk_arch.pdf}
  \includegraphics[width=0.45\textwidth]{../plots/ntk_eigvals_single_plot_arch.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=1\textwidth]{plots/ntk_alignment.pdf}
