...
diagnostic metrics to be explored in future works. Indeed, many aspects
merit further investigations. First of all, we need to study in detail the
outcome of a similar analysis when applied to a more complex and realistic
framework, including multiple fitted flavors and real data. For data that depend
linearly on the PDFs, the extension of the formalism is straightforward. 
However, the agreement with the analytical predictions need to be tested by 
performing the numerical simulations. Further insights could be gained by exploring different 
parametrizations beyond neural networks.
