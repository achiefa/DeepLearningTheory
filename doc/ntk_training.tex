...
function $\mathcal{L}$. For sufficient small learning rates $\eta$, this
...
integrating Eq.~\ref{eq:FlowEquationNoIndices} analytically. We come back
...
\begin{figure}[ht!]
  ...
  lies entirely in the subspace spun by the first four eigenvactors of the NTK 
