...
\begin{figure}[ht]
  ...
  confidence level. Note that the subdominant eigenvalues $\lambda_3$, $\lambda_4$
  and $\lambda_5$ have increased by one or two orders of magnitude by the end of the rich 
  training phase.}
